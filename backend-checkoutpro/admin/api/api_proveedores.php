...
function enviarPedido() {
    ...
    // Reemplazos dinámicos en el mensaje
    if (strpos($mensaje, '[CONTACTO]') !== false) {
        $contacto = !empty($proveedor['persona_contacto']) ? $proveedor['persona_contacto'] : '';
    ...
    // Generar URLs según vía de envío
    ...
    try {
        ...
        $resultado = $stmt_insert->execute([
            ...
            'productos_solicitados' => $productos_texto,
