...
function configureQZTrayUniversal() {
    ...
    qz.security.setSignaturePromise(function(toSign) {
        return function(resolve, reject) {
            ...
            const baseUrl = window.location.protocol + '//' + window.location.host;
            const signPath = baseUrl + '/Totem_Murialdo/backend/api/sign_message.php';
            ...
            .then(function(response) {
                if (response.ok) {
                    ...
                    const altSignPaths = [
                        baseUrl + '/Totem_Murialdo/backend/api/sign_message.php',  // Ruta principal encontrada
                        '../../backend/api/sign_message.php',                      // Ruta relativa que funciona
                        '/backend/api/sign_message.php',
                        '/api/sign_message.php',
                        './backend/api/sign_message.php',
                        baseUrl + '/certsite/Totem_Murialdo/backend/api/sign_message.php'
                    ];
