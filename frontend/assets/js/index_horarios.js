// Script para deshabilitar la UI de index.html fuera de horario (usa la misma lógica que el tótem)
async function verificarHorariosIndex() {
    try {
...
function mostrarOverlayFueraHorario(msg) {
    ...
    if (!overlay) {
      ...
      <div>El sistema está fuera del horario de atención</div>\
...
verificarHorariosIndex();
setInterval(verificarHorariosIndex, 60000);
